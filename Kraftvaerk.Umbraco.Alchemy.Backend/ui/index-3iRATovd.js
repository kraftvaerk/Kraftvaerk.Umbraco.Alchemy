...
customElements.define = function(e, t, r) {
  if (e === me && E) {
    import("./alchemy-design-editor-property.element-DWWgH12P.js").then(({ createAlchemyDesignEditorPropertyClass: s }) => {
      const a = s(t);
      V(e, a, r);
    });
    return;
...
const Ae = async (e, t) => {
  ...
  }), E && import("./alchemy-content-type-header.element-4cNVW8PP.js").then(({ patchAlchemyContentTypeHeader: a }) => {
    a();
  });
  const r = {
    type: "entityAction",
    ...
    name: "Do Alchemy",
    weight: 10,
    api: () => import("./alchemy-document-type.action-D5SHiJr1.js"),
...
//# sourceMappingURL=index-3iRATovd.js.map
