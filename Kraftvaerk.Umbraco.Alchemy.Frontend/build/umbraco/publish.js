...
export default function publish() {
    ...
    const solutionPath = join(rootDir, 'Kraftvaerk.Umbraco.Alchemy.sln');
    const projectPath = join(rootDir, 'Kraftvaerk.Umbraco.Alchemy.Backend');
    const csprojectPath = join(projectPath, 'Kraftvaerk.Umbraco.Alchemy.Backend.csproj');
